...
The descriptive statistics can be found in Figure 1, and the correlation coefficients can be found in Figure 2. There was statistically significant correlation between the log-transformed written frequency for each verb in the CELEX corpus and valency, r(272) = .57, p < .001. The results of the bivariate regression revealed that the independent variable, valency, statistically significantly predicted the dependent variable, log-transformed written frequency, F(1, 270) = 132.1, p < .001. Figure 3 provides a scatterplot displaying the relationship between log-transformed written frequency and valency. The scatterplot revealed that the correlation was greatest between verbs that were morphologically irregular.
